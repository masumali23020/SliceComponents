...
<div className='max-w-7xl mx-auto grid grid-1 sm:grid-cols-2 lg:grid-cols-3'>
    {[1,2,3].map((item,ind)=> (
        <div key={ind} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow ">
        <a href="#">
            <img className="p-8 rounded-t-lg" src="https://images.pexels.com/photos/259588/pexels-photo-259588.jpeg?auto=compress&cs=tinysrgb&w=600" />
        </a>
