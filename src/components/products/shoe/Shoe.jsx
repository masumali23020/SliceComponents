  ...
  return (
    <div className="mt-5">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-start text-3xl text-gray-700">Nike Shoe</h1>
        <Link
      ...
      <div className="flex space-x-2 mt-5 ">
        {[1, 2, 3, 4].map((item, ind) => (
          <div
            key={ind}
            className=" flex w-[300px] flex-col items-start rounded-[8px] shadow-custom1 bg-white relative overflow-hidden"
          >
            ...
            <div className="relative z-50 w-full flex flex-col justify-center items-center space-y-4 p-[24px]  ">
              ...
              <div className="flex justify-center space-x-3">
                ...
                <del className="text-[#E3E3E3] text-[14px] font-medium">
                  $38.00
                </del>
              </div>
            </div>
